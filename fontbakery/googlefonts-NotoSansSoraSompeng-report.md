...
* 🔥 **FAIL** Not all fonts passed in the command line are in the same directory. This may lead to bad results as the tool will interpret all font files as belonging to a single font family. The detected directories are: ['fonts/NotoSansSoraSompeng/googlefonts/ttf', 'fonts/NotoSansSoraSompeng/googlefonts/variable-ttf'] [code: single-directory]
...
</div></details><br></div></details><details><summary><b>[9] NotoSansSoraSompeng-Bold.ttf</b></summary><div><details><summary>⚠ <b>WARN:</b> Glyphs are similiar to Google Fonts version? (<a href="https://font-bakery.readthedocs.io/en/stable/fontbakery/profiles/googlefonts.html#com.google.fonts/check/production_glyphs_similarity">com.google.fonts/check/production_glyphs_similarity</a>)</summary><div>
...
* ⚠ **WARN** The following glyphs have on-curve points which have potentially incorrect y coordinates:
	...
	* d (U+0064): X=301.0,Y=435.0 (should be at x-height 433?)

	* e (U+0065): X=432.5,Y=-0.5 (should be at baseline 0?)

	* f (U+0066): X=380.0,Y=434.0 (should be at x-height 433?)

	* f (U+0066): X=251.0,Y=434.0 (should be at x-height 433?)

	* f (U+0066): X=102.0,Y=434.0 (should be at x-height 433?)

	* f (U+0066): X=20.0,Y=434.0 (should be at x-height 433?)
...
* ⚠ **WARN** The following glyphs have semi-vertical/semi-horizontal lines:
	...
	* u110D4 (U+110D4): L<<288.0,0.0>--<156.0,1.0>>

	* u110DC (U+110DC): L<<357.0,288.0>--<358.0,624.0>> 

	* And u110DC (U+110DC): L<<490.0,800.0>--<489.0,288.0>> [code: found-semi-vertical]
</div></details><br></div></details><details><summary><b>[10] NotoSansSoraSompeng-Medium.ttf</b></summary><div><details><summary>⚠ <b>WARN:</b> Glyphs are similiar to Google Fonts version? (<a href="https://font-bakery.readthedocs.io/en/stable/fontbakery/profiles/googlefonts.html#com.google.fonts/check/production_glyphs_similarity">com.google.fonts/check/production_glyphs_similarity</a>)</summary><div>
...
* ⚠ **WARN** The combined length of family and style exceeds 27 chars in the following 'WINDOWS' entries:
 FONT_FAMILY_NAME = 'Noto Sans Sora Sompeng Medium' / SUBFAMILY_NAME = 'Regular'
...
* ⚠ **WARN** The following glyphs have on-curve points which have potentially incorrect y coordinates:
	...
	* c (U+0063): X=426.0,Y=431.0 (should be at x-height 433?)
...
* ⚠ **WARN** The following glyphs have semi-vertical/semi-horizontal lines:
	...
	* u110DC (U+110DC): L<<342.0,263.0>--<343.0,646.0>> [code: found-semi-vertical]
</div></details><br></div></details><details><summary><b>[7] NotoSansSoraSompeng-Regular.ttf</b></summary><div><details><summary>⚠ <b>WARN:</b> Combined length of family and style must not exceed 27 characters. (<a href="https://font-bakery.readthedocs.io/en/stable/fontbakery/profiles/googlefonts.html#com.google.fonts/check/name/family_and_style_max_length">com.google.fonts/check/name/family_and_style_max_length</a>)</summary><div>


* ⚠ **WARN** The combined length of family and style exceeds 27 chars in the following 'WINDOWS' entries:
 FONT_FAMILY_NAME = 'Noto Sans Sora Sompeng' / SUBFAMILY_NAME = 'Regular'
...
Use -F or --full-lists to disable shortening of long lists. [code: found-short-segments]
</div></details><br></div></details><details><summary><b>[9] NotoSansSoraSompeng[wght].ttf</b></summary><div><details><summary>💔 <b>ERROR:</b> Check font names are correct (<a href="https://font-bakery.readthedocs.io/en/stable/fontbakery/profiles/googlefonts.html#com.google.fonts/check/font_names">com.google.fonts/check/font_names</a>)</summary><div>
